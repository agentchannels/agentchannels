...
- A reachable AgentChannels Relay endpoint
...
Prepare a Slack Binding and app manifest:

```sh
agentchannels --json connect slack \
  --agent ag_... \
...
```sh
agentchannels daemon --relay-url wss://relay.example.com
```
