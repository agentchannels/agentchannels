import type { Binding, ConnectorType } from "../core/types.js";
...
export class RelayManager {
  ...
  public constructor(private readonly options: RelayManagerOptions) {
  ...
  private async enrollAndPersist(
    ...
    if (registration.installationId !== identity.installationId) {
      throw new Error("Relay enrollment returned a different installation ID");
    }
